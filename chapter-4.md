...
* **Offline Testing:** چیپ در محیط test قرار می‌گیرد و بررسی می‌شود.
* **Online Testing:** مدار وقتی داخل سیستم نصب شده و در حال کار یا idle است، تست می‌شود.
...
### 11. Boundary Scan برای testing است، نه فقط watermarking

Watermarking از scan chain سوءاستفاده/استفادهٔ خلاقانه می‌کند. اصل boundary scan برای testability است.
...
### 13. Ring Oscillator با تعداد فرد inverter نوسان می‌کند
...
### 14. LFSR با all-zero گیر می‌کند
